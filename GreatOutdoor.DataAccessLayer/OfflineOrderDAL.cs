...

    {
        ...
        public (bool, Guid) AddOfflineOrderDAL(OfflineOrder newOfflineOrder)
        {
            ...
            try
            {
                ...
                newOfflineOrder.LastModifiedDateTime = DateTime.Now;
        ...
        public bool UpdateOfflineorderDAL(OfflineOrder updateOfflineOrder)
        {
            ...
            try
            {
                ...
                OfflineOrder matchingOfflineOrder = GetOfflineOrderByOfflineOrderIDDAL(updateOfflineOrder.OfflineOrderID);

                if (matchingOfflineOrder != null)
                {
                    //Update OfflineReturn details
                    ReflectionHelpers.CopyProperties(updateOfflineOrder, matchingOfflineOrder, new List<string>() { "RetailerID", "SalesPersonID", "TotalAmount", "TotalQuantity" });
                    matchingOfflineOrder.LastModifiedDateTime = DateTime.Now;
