...
{   /// <summary>
...

    {
        ...
        public bool UpdateOfflineOrderDetailDAL(OfflineOrderDetail updateOfflineOrderDetail)
        {
            ...
            try
            {
                //Find OfflineOrderDetail based on OfflineOrderDetailID
                OfflineOrderDetail matchingOfflineOrderDetail = GetOfflineOrderDetailByOfflineOrderDetailIDDAL(updateOfflineOrderDetail.OfflineOrderDetailID);

                if (matchingOfflineOrderDetail != null)
                {
                    //Update OfflineOrderDetail details
                    ReflectionHelpers.CopyProperties(updateOfflineOrderDetail, matchingOfflineOrderDetail, new List<string>() { "Quantity", "OfflineOrderID", "ProductID", "UnitPrice", "TotalPrice", "ProductName" });
